...
pub const CRATE_NAME: &str = "osm-pbf-reader";
...
pub fn bench_file<M: Measurement>(group: &mut BenchmarkGroup<'_, M>, map_file: &str) {
    super::bench_file(group, map_file, "osm-pbf-reader/decode-sync", decode_sync);
    super::bench_file(group, map_file, "osm-pbf-reader/decode-sync2", decode_sync2);
    super::bench_file(group, map_file, "osm-pbf-reader/decode-par", decode_par);
}
